  ...
  return (
    <div className="group relative flex cursor-pointer">
      <motion.img
        ...
        className="rounded-full border border-davys-gray object-cover w-24 h-24 xl:h-32 xl:w-32 md:h-28 md:w-28 filter group-hover:grayscale transition duration-300 ease-in-out"
      />
